...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/classyconf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14284&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/classyconf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `classyconf` can be installed with:

```
conda install classyconf
```

It is possible to list all of the versions of `classyconf` available on your platform with:
